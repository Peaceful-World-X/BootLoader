...
# -*- coding: utf-8 -*-
"""
BootLoader测试服务器 - 模拟下位机响应
支持TCP网口模式(端口503)和串口模拟
"""
...
class BootLoaderTestServer:
    ...
    def handle_client(self, conn, addr):
        ...
        try:
            ...
            print(f"[错误] 处理客户端时出错: {e}")
        finally:
            conn.close()
            print(f"[断开] 客户端断开: {addr}\n")
...
def main():
    ...
    server = BootLoaderTestServer(port)
